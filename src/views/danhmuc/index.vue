    ...
    <div class="app-container">
        ...
        <el-table :data="paginatedData" style="width: 100%;">
                ...
                <template #default="scope">
                    <div v-if="editingRow === scope.$index">
                        <el-select v-model="editKhoiLop" placeholder="Select" size="small" style="width: 240px">
                            <el-option v-for="item in khoiLopData" :key="item.kl_ma" :label="item.kl_ten" :value="item.kl_ma" />
                        </el-select>
                    </div>
                    <div v-else>
                        {{ scope.row.kl_ten }}
            ...
            <el-table-column align="right">
                <template #header>
                    <el-input v-model="search" size="small" placeholder="Tìm kiếm môn học" />
                </template>
                <template #default="scope">
            ...
            <el-form :model="form">
                ...
                <el-form-item label="Chọn khối lớp:" :label-width="formLabelWidth">
                    <el-select v-model="form.kl_ma" placeholder="Chọn khối lớp">
                        <el-option v-for="khoiLop in khoiLopData" :key="khoiLop.kl_ma" :label="khoiLop.kl_ten" :value="khoiLop.kl_ma" />
                    </el-select>
                </el-form-item>
            </el-form>
            <template #footer>
