...
def calculate_query_tf_idf(query_words):
    ...
    for word in query_words:
        ...
        # Lấy dữ liệu từ bảng chimuctieude
...
def get_top_documents(query_words, num_top=10):
    ...
    # Tính điểm cosine similarity cho từng tài liệu
    cosine_scores = {}
    ...
    # Sắp xếp các tài liệu theo điểm cosine similarity giảm dần
    sorted_documents = sorted(cosine_scores.items(), key=lambda x: x[1], reverse=True)
    
    # Trả về top num_top tài liệu
